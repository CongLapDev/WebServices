...
// VnPay config commented out - not needed for sandbox
// @Component
public class VNPayConfig {

    // Các giá trị mặc định tạm thời
    public String vnp_PayUrl = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
    public String vnp_Returnurl = "/vnpay-payment";
    public String vnp_TmnCode = "CTTVNP01";
    public String vnp_HashSecret = "hgkdgkd";
